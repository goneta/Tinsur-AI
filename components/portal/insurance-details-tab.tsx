    ...
    const refreshData = useCallback(async () => {
        ...
        try {
            ...
            const fetchedVehicles: PortalVehicle[] = (clientData.automobile_details || []).map((v: ClientAutomobile) => ({
                ...
                vehicleType: (v.fuel_type === 'Automatic' ? 'Automatic' : 'Manual') as PortalVehicle['vehicleType'],
                vehicleAge: 'N/A',
                modified: false,
                imageUrl: (v as any).vehicle_image_url || 'https://images.unsplash.com/photo-1541899481282-d53bffe3c35d?auto=format&fit=crop&q=80&w=400'
            }));
