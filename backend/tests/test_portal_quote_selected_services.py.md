# test_portal_quote_selected_services.py

Source: `backend/tests/test_portal_quote_selected_services.py`
Documentation: `backend/tests/test_portal_quote_selected_services.py.md`
