# add_client_eligibility_fields.py

Source: `backend/scripts/add_client_eligibility_fields.py`
Documentation: `backend/scripts/add_client_eligibility_fields.py.md`
Nearest DOX: `backend/AGENTS.md`
