# product_application_detail.py

Source: `backend/app/schemas/product_application_detail.py`
Documentation: `backend/app/schemas/product_application_detail.py.md`
Nearest DOX: `backend/app/AGENTS.md`

## Purpose

- Request/response schema source.
