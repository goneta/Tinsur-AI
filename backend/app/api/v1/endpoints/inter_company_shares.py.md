# inter_company_shares.py

Source: `backend/app/api/v1/endpoints/inter_company_shares.py`
Documentation: `backend/app/api/v1/endpoints/inter_company_shares.py.md`
