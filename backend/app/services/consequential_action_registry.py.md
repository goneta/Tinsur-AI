# consequential_action_registry.py

Source: `backend/app/services/consequential_action_registry.py`
Documentation: `backend/app/services/consequential_action_registry.py.md`
