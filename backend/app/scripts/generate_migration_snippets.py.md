# generate_migration_snippets.py

Source: `backend/app/scripts/generate_migration_snippets.py`
Documentation: `backend/app/scripts/generate_migration_snippets.py.md`
