...
"""
from sqlalchemy import Column, String, Float, DateTime, ForeignKey, Enum, JSON, Numeric, Date, Text, Integer, Boolean
from sqlalchemy import Column, String, Float, DateTime, ForeignKey, Enum, JSON, Numeric, Date, Text, Integer, Boolean
...
class Quote(Base):
    ...
    # Status
    status = Column(String(50), default='draft')  # 'draft', 'draft_from_client', 'sent', 'accepted', 'policy_created', 'submitted', 'under_review', 'approved', 'rejected', 'expired', 'archived', 'recommended'
    valid_until = Column(Date)
    valid_for_days = Column(Integer, default=30)
    
    # Auto-generation
    auto_generated = Column(Boolean, default=False)  # True if auto-generated by AI
    recommendation_order = Column(Integer, nullable=True)  # Order in AI recommendation list (1=cheapest, 2=second, etc.)
