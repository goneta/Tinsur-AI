# policy-template-api.ts

Source: `frontend/lib/policy-template-api.ts`
Documentation: `frontend/lib/policy-template-api.ts.md`
Nearest DOX: `frontend/lib/AGENTS.md`

## Purpose

- Shared library, API client, or utility source.
